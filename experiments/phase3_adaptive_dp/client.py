"""
client.py  (Phase 3 — Adaptive Differential Privacy)
------------------------------------------------------------------
...
Changes from Phase 2:
  ...
  - Saves per-client privacy log to results/phase3_adaptive_dp/

Usage:
    python experiments/phase3_adaptive_dp/client.py <client_id>
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        print('Usage: python experiments/phase3_adaptive_dp/client.py <client_id>')
        sys.exit(1)
